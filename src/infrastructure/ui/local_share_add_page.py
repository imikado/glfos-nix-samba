...
class LocalShareAddPage(Adw.NavigationPage):

    _local_share_domain:LocalShareDomain
    _navigation_view:Adw.NavigationView


    def __init__(self, local_share_domain:LocalShareDomain,navigation_view:Adw.NavigationView, show_notification, *args, **kwargs):
        ...
        self.set_title(_('Add Local Share'))
        ...
        self.combo_access_mode.set_selected(1)
        ...
        self.switch_read_only.set_active(True)
    ...
    def on_add_clicked(self, _button):
        ...
        try:
            self._local_share_domain.add_item(local_share)
